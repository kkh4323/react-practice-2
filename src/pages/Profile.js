...
const Profile = () => {
    ...
    //     setPhone(data.phone)
    //     setMarketingAgree(data.agreeOfTerm.marketingAgree)
    //     setEtc(data.agreeOfTerm.etc)
    }
                        ...
                        <Col className={"col-6"}>
                            <Form className="d-grid" onSubmit={submitHandler}>
                                <Card style={{ width: '100%' }}>
                                    <Card.Img variant="top" src={data.profileImg} style={{"width": "250px", "justify-content": "center"}} />
                                    <Card.Body>
